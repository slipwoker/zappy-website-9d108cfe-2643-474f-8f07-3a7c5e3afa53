document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    function getFieldError(field) {
      ...
      if ((type === 'text' || field.tagName.toLowerCase() === 'textarea') && value !== '') {
        if (value.length < 2) {
    ...
    const validatableFields = 'input:not([type="submit"]):not([type="button"]):not([type="reset"]):not([type="hidden"]), textarea, select';

    contactForm.addEventListener('blur', function (e) {
      const field = e.target.closest(validatableFields);
      if (!field) return;
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      const fields = contactForm.querySelectorAll(validatableFields);
      let isValid = true;
  ...
  const animatedEls = document.querySelectorAll('.fade-in, .animate-on-scroll, [data-animate]');
    ...
    const observer = new IntersectionObserver(function (entries) {
      entries.forEach(function (entry) {
        if (entry.isIntersecting) {
          ...
          el.classList.remove('scroll-animate-ready');
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "ReachWave uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '9d108cfe-2643-474f-8f07-3a7c5e3afa53',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9d108cfe-2643-474f-8f07-3a7c5e3afa53';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9d108cfe-2643-474f-8f07-3a7c5e3afa53';
